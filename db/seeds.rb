...
Car.create!(manufacturer: 'BMW', model: '536', style: 'Sedan', hourly_rate: 8.5, location: '2345 Wake forest, Raleigh, NC 23456', license_plate: 'MXCX21', status: 'Approved', carstatus: 'Avaiable' )
...
Car.create!(manufacturer: 'Jaguar', model: 'elite', style: 'Sedan', hourly_rate: 9.5, location: '2345 Wake forest, Raleigh, NC 23456', license_plate: 'RGB21', status: 'Approved', carstatus: 'Available' )
Car.create!(manufacturer: 'Benz', model: '5 series', style: 'Sedan', hourly_rate: 10.5, location: '2345 Wake forest, Raleigh, NC 23456', license_plate: 'NIRM21', status: 'Approved', carstatus: 'Available' )
